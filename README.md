...
| 메인 페이지 | 문제 리스트 |
|:---:|:---:|
| <img width="500" alt="메인 페이지" src="https://github.com/user-attachments/assets/0bcd409d-4315-42c3-a955-e0b3e9569974" /> | <img width="500" alt="문제 리스트" src="https://github.com/user-attachments/assets/e2ad19af-eef1-4a87-91e0-dfa2521ad2a4" /> |
| AWS 자격증 덤프 문제 메인 페이지로, 다양한 AWS 자격증 카테고리와 문제를 확인할 수 있습니다. | AWS Certified Cloud Practitioner 자격증에 대한 문제 목록 페이지입니다. |

### 자격증 상세 및 진행 현황

| 자격증 상세 정보 | 마이페이지 |
|:---:|:---:|
| <img width="500" alt="상세정보" src="https://github.com/user-attachments/assets/025b2dff-2afa-4c83-ae47-18b83be7ae25" /> | <img width="500" alt="마이페이지" src="https://github.com/user-attachments/assets/b14d161c-ce56-4b8a-bca6-10ebc109dff1" /> |
| AWS Certified Cloud Practitioner 자격증에 대한 상세 정보 페이지로, 시험 비용, 지원 언어, 학습 자료 등의 정보를 제공합니다. | 사용자의 학습 진행 상황을 한눈에 볼 수 있는 마이페이지입니다. 각 자격증별 전체 문제 수, 시도한 문제 수, 정답 문제 수를 확인할 수 있습니다. |

### 문제 풀이 결과

| 정답 화면 | 오답 화면 |
|:---:|:---:|
| <img width="500" alt="채점결과" src="https://github.com/user-attachments/assets/237f7ace-2f4b-4ea5-8dca-e0de790a0305" /> | <img width="500" alt="오답1" src="https://github.com/user-attachments/assets/cfe1914b-573c-4e40-814d-0a1b25c24291" /> |
| 정답을 맞췄을 때의 결과 화면입니다. 정답에 대한 설명과 함께 다음 문제로 넘어갈 수 있습니다. | 오답을 선택했을 때의 결과 화면입니다. 정답과 함께 오답 노트에 추가할 수 있는 기능을 제공합니다. |

### 오답 노트

<img width="500" alt="오답2" src="https://github.com/user-attachments/assets/72b04c42-c583-40aa-bb4c-2a7a0647034b" />
